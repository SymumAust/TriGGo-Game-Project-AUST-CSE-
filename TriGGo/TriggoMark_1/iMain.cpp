...
char score[10][40] = { "numbers9\\0.bmp", "numbers9\\1.bmp", "numbers9\\2.bmp", "numbers9\\3.bmp", "numbers9\\4.bmp", "numbers9\\5.bmp", "numbers9\\6.bmp", "numbers9\\7.bmp", "numbers9\\8.bmp", "numbers9\\9.bmp" };// img size 141 x 192 index 10
...
int obstracle_rate = 30;
int imgIndex = 0;
int indexSpreed = 0;
int indexSpreedRange = 5;
...
void iDraw()
{
	...
	case 3:
		...
		if (indexSpreed == indexSpreedRange && pause9){ //indexSpreedRange 5-10 best
			...
			if (point >= 25){                      //abstracle rate will increase after point 50
				obstracle_rate = 40;
			}
			if (point >= 50){                      //game change after 80 point
...
{
	backGroundPossition();
	iSetTimer(100, backGroundChange);
	imageposfunction();
